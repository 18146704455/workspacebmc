...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->multiAddrSem) == 0)
#else
...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->atuRegsSem) == 0)
#else
...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->vtuRegsSem) == 0)
#else
...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->statsRegsSem) == 0)
#else
...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->pirlRegsSem) == 0)
#else
...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->ptpRegsSem ) == 0)
#else
...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->tblRegsSem) == 0)
#else
...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->eepromRegsSem) == 0)
#else
...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->phyRegsSem) == 0)
#else
...
#if defined(LINUX)
    if(gtSemCreate(dev,GT_SEM_FULL,&dev->hwAccessRegsSem) == 0)
#else
